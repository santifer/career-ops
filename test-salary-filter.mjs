...
// ── Re-implement the functions under test (isolated from scan.mjs / ashby.mjs) ──
// This avoids import issues and tests the pure logic.

// --- Ashby compensation parsing ---
