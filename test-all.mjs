...
const scripts = [
  ...
  { name: 'ingest-self-test.mjs', expectExit: 0 },
...
const allowedFiles = [
  ...
  'CHANGELOG.md', 'TRADEMARK.md', '.claude-plugin/plugin.json', '.claude-plugin/marketplace.json',
...
const expectedModes = [
  ...
  'ofertas.md', 'pipeline.md', 'ingest.md', 'project.md', 'tracker.md', 'training.md',
];
