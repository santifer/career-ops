...
1. 正規 CLI で status を "Applied" に update: `node scripts/js/set-status.mjs <report#> Applied`（`applications.md` のテーブルを手動編集しない）
