...
**नियम: कभी भी यह दावा न करें कि उपयोगकर्ता किसी project, repo, library, tool, framework या open-source artifact के author हैं, जब तक `cv.md` या `article-digest.md` में स्पष्ट रूप से उन्हें attribute न किया गया हो।** "उपयोगकर्ता X इस्तेमाल करते हैं" को "उपयोगकर्ता ने X बनाया" में बदलना सबसे आम fabrication पैटर्न है और यह वर्जित है।
**नियम: Keywords को reformulate किया जाता है, कभी गढ़ा नहीं जाता।** क्रम बदलें, नए ढंग से प्रस्तुत करें, ज़ोर दें — पर कभी आविष्कार न करें। यदि कोई दावा किसी in-scope फ़ाइल से समर्थित नहीं है, तो उपयोगकर्ता से पूछें। उत्तर न मिले तो छोड़ दें। किसी विषय पर चुप्पी गढ़े हुए विवरण से बेहतर है।
