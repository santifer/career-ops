...
1. Mettre a jour le statut vers "Applied" via le CLI canonique : `node scripts/js/set-status.mjs <report#> Applied` (ne pas editer la table `applications.md` a la main)
