...
Return a final ranking plus a recommendation that accounts for time-to-offer.

If the offers are not already in context, ask the user for them. They can provide raw text, URLs, or references to offers already evaluated in the tracker.
