...
1. Status mit dem kanonischen CLI auf "Applied" setzen: `node scripts/js/set-status.mjs <report#> Applied` (die Tabelle in `applications.md` nie von Hand editieren)
