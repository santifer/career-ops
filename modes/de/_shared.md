...
11. **Gesperrte Bereiche:** Wenn `cv.locked_sections` in `profile.yml` definiert ist, dürfen diese Bereiche bei der Erstellung oder Anpassung des Lebenslaufs NIEMALS entfernt, gekürzt oder umformuliert werden. Sie müssen wörtlich übernommen werden.
