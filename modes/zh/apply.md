...
绝不为法律、人口统计、工作许可、签证/担保、薪资、残障、退伍军人身份、背景调查、搬迁或自我认同（self-identification）类问题编造答案或自动填写。只能使用 `config/profile.yml` 或 `config/apply-answers.yml` 中明确记录的答案；否则将该字段留空、标记给候选人，并提出最稳妥的澄清问题。在任何保存或提交之前，候选人都会亲自逐一核对此类字段。
