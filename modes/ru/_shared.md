...
11. **Заблокированные разделы:** Если в `profile.yml` определен `cv.locked_sections`, НИКОГДА не удаляйте, не сокращайте и не перефразируйте эти разделы при создании или адаптации резюме. Они должны быть представлены дословно.
