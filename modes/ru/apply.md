...
- **Лучше с Patchright**: Кандидат видит браузер, Claude взаимодействует со страницей.
- **Без Patchright**: Кандидат делится скриншотом или вставляет вопросы вручную.
...
**С Patchright:** Snapshot активной страницы. Прочитать заголовок, URL, видимое содержимое.

**Без Patchright:** Попросить кандидата:
