...
## Чувствительные поля (ЖЁСТКОЕ ПРАВИЛО)

Никогда не выдумывайте и не заполняйте автоматически ответы на вопросы о юридических аспектах, демографии, разрешении на работу, визе/спонсорстве, зарплате, инвалидности, статусе ветерана, проверке биографии, переезде или самоидентификации. Используйте только ответ, явно записанный в `config/profile.yml` или `config/apply-answers.yml`; иначе оставьте поле пустым, пометьте его для кандидата и задайте самый безопасный уточняющий вопрос. Кандидат лично проверяет каждое такое поле до любого сохранения или отправки.
