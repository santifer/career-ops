...
1. Обновить статус на "Applied" через канонический CLI: `node scripts/js/set-status.mjs <report#> Applied` (не редактировать таблицу `data/applications.md` вручную)
