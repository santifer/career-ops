...
絕不為法律、人口統計、工作許可、簽證/贊助、薪資、身心障礙、退伍軍人身分、背景調查、搬遷或自我認同（self-identification）類問題捏造答案或自動填寫。只能使用 `config/profile.yml` 或 `config/apply-answers.yml` 中明確記錄的答案；否則將該欄位留空、標記給候選人，並提出最穩妥的釐清問題。在任何儲存或送出之前，候選人都會親自逐一檢視此類欄位。
