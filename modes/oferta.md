...
**9. Immigration-Status Requirement Overreach** (from JD text; jurisdiction from `config/profile.yml` → `location` (country + city/province/state), same region-aware pattern as signal 6):
