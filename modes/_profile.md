...
**In evaluations (scoring) — STRICT:**
- Remote: OK, any location
- Hybrid in São Paulo / Grande SP: OK (score 4.0+)
- Hybrid outside São Paulo / Grande SP: penalize hard (score 1.5-2.0)
- On-site (any day ≥ 1) outside São Paulo / Grande SP: near-disqualifier (score 1.0-1.5)
- 100% on-site outside São Paulo / Grande SP: automatic disqualifier (score < 1.5)

**Why this matters for Fernando:**
He lives in São Paulo. Any commute beyond Grande SP (Cotia, Arujá, Osasco, ABC, etc.) is a daily burden. Roles requiring 4+1 or 5-day on-site in these areas score 1.5 or below. Only remote or hybrid IN São Paulo proper scores well.
