...
- [ ] https://boards.greenhouse.io/company/jobs/456 | Company Inc | Senior Data Analyst
- [!] https://private.url/job — Error: login required

## Processed
- [x] #143 | https://jobs.example.com/posting/789 | Acme Corp | Data Analyst | 4.2/5 | PDF ✅
- [x] #144 | https://boards.greenhouse.io/xyz/jobs/012 | BigCo | CRM Developer | 2.1/5 | PDF ❌
```
...
2. Extract the number from the prefix (e.g., `142-company...` → 142)
