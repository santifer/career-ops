...
| `interview-prep/retracted-claims.md` | Claims the candidate has rejected as indefensible — hard gate in practice and debrief (format: `**"claim"** (context).` Reason: one-line reason.) |
