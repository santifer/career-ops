...
- **Ashby**: `"Senior Data Analyst (Remote) @ Acme Corp"` → title: `Senior Data Analyst`, company: `Acme Corp`
- **Greenhouse**: `"Data Engineer at BigCo"` → title: `Data Engineer`, company: `BigCo`
- **Lever**: `"Dynamics CRM Developer @ TechCorp"` → title: `Dynamics CRM Developer`, company: `TechCorp`
...
https://...	2026-02-10	Indeed — Data Analyst	Data Analyst	Acme	added
https://...	2026-02-10	Greenhouse — CRM Dev	Junior CRM Dev	BigCo	skipped_title
https://...	2026-02-10	Indeed — Data Engineer	Data Engineer	OldCo	skipped_dup
https://...	2026-02-10	LinkedIn — SharePoint	SharePoint Admin	ClosedCo	skipped_expired
```
