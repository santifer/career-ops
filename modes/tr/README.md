...
| `scan.md` | `modes/scan.md` (EN) | Portal Tarayıcı (İş Keşfi) |
| `batch.md` | `modes/batch.md` (EN) | Toplu (Batch) değerlendirme çalıştırıcısı |
| `pdf.md` | `modes/pdf.md` (EN) | Özgeçmiş PDF Üreticisi |
