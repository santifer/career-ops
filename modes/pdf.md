...
14. Escribe HTML a `output/cv-{candidate}-{company}-{YYYY-MM-DD}.html`
15. Ejecuta: `node generate-pdf.mjs output/cv-{candidate}-{company}-{YYYY-MM-DD}.html output/cv-{candidate}-{company}-{YYYY-MM-DD}.pdf --format={letter|a4}`
