...
11. Inject keywords naturally into existing wins (NEVER invent)
...
- No nested tables
- Spread JD keywords: Summary (top 5), first bullet of each role, Skills section
