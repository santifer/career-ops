...
1. Aggiornare lo stato ad "Applied" con la CLI canonica: `node scripts/js/set-status.mjs <report#> Applied` (non modificare la tabella di `applications.md` a mano).
