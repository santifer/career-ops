---
name: deep
description: "Generación de prompts estructurados para investigación profunda de empresas"
tags: [career, job-search, research, deep-analysis]
---
...
Dado mi perfil (read from cv.md and config/profile.yml for specific experience):
