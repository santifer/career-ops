---
name: pdf
description: "Generación de CVs en PDF desde Markdown/HTML con soporte Canva MCP"
tags: [career, job-search, pdf, cv-generation, canva]
---
...
15. Ejecuta: `exec node generate-pdf.mjs /tmp/cv-{candidate}-{company}.html output/cv-{candidate}-{company}-{YYYY-MM-DD}.pdf --format={letter|a4}`
