...
| **Cover Letter Sites** | Build and deploy tailored Cloudflare Worker SPAs for high-fit applications |
...
├── job-app-sites/               # Generated application microsites (gitignored)
