...
export const CACHES = [
  ...
  },
  {
    ...
    costEstimate: 1.0,
    hardMaxTtlDays: 7,
    // Phase 2 will flip provider to perplexity-agent for live Glassdoor/Blind/Reddit scraping;
    // Phase 1.5 keeps it on anthropic-sonnet so the adapter route is wired-but-cheap.
    provider: 'anthropic-sonnet',
    dedupScope: 'company',
