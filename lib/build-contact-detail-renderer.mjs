...
function _composeFallbackBody(c, overlap, cv) {
  ...
  const cvSignal = (() => {
    ...
    if (/research|policy|safety|red.?team|eval/.test(role)) {
      return `I've spent the last 18 months in the gap between research output and operational comms, running structured evals and writing the kind of post-mortems that change how a team thinks about a class of failure.`;
    }
