...
export async function callAnthropicCached(req) {
  ...
  const t0 = Date.now();
  // Phase A.0 hardening (2026-05-19): defensive default timeout if caller didn't pass one.
  // Prevents the 2h41m hang Mitchell hit when 5 ESTABLISHED HTTPS sockets idled on no AbortSignal.
