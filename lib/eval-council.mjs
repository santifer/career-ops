...
// 2026-05-17 — eval-council Gemini slot upgraded to gemini-3-flash-preview
// per Mitchell's preference. gemini-2.0-flash deprecated, gemini-2.5-flash
// still works as fallback if Google deprecates 3-flash-preview during
// preview lifecycle.
