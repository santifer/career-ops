...
export function extractProseText(raw) {
  ...
  // Strip YAML/TOML frontmatter — ONLY when the document begins with `---`.
  // Without the leading-position check, mid-document `---` separators (which
  // mark section breaks, not frontmatter) get treated as frontmatter fences
  // and silently lop off load-bearing prose. Verified by DELTA Δ.1 audit
  // 2026-05-19: voice-reference.md § Canonical Exemplar lost ~400 prose words
  // to this bug before the leading-position check was added.
