...
test("findLastEventForReport returns latest event for report_id", async () => {
  ...
  await writeFile(
    eventsPath,
    [
      { report_id: "001", real_outcome: "neutral_excluded", outcome_source: "inferred", ts: "2026-04-25T00:00:00Z" },
      { report_id: "002", real_outcome: "positive", outcome_source: "inferred", ts: "2026-04-26T00:00:00Z" },
      { report_id: "001", real_outcome: "inferred_negative", outcome_source: "inferred", ts: "2026-04-27T00:00:00Z" },
