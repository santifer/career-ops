...
<cover_letter_optimization_system>
  <metadata>
    ...
    <version>1.0</version>
    <sibling_of>shivani-resume-optimization-system-based-on-job-description.md</sibling_of>
    <revision_notes>
...
If score <90 (no hard-fail) -> Output deficiency log + corrected LaTeX
  ...
  <phase_1>
    ...
    <analysis_steps>
      ...
      <step number="4">Identify the JD archetype using these signals:
        <archetype name="Azure Data Engineer">Azure Data Factory, Azure Synapse Analytics, Databricks, Delta Lake, PySpark, data pipelines, ETL, ELT, Azure Data Lake</archetype>
        <archetype name="Data Platform Engineer">dbt, Snowflake, BigQuery, Redshift, data warehouse, data lakehouse, data modeling</archetype>
        <archetype name="Analytics Engineer">Power BI, DAX, data visualization, reporting, BI, dashboards, KPI</archetype>
        <archetype name="Data Architect">data governance, data mesh, master data management, metadata, data catalog, architecture</archetype>
  ...
  <phase_2>
    ...
    <skeleton>
      <paragraph number="1" purpose="Hook" sentences="3-4">
        ...
        <required>Leads with the candidate's background: Azure Data Engineering experience building production-grade data pipelines and cloud-native data platforms.</required>
  ...
  <phase_3>
    ...
    <approved_proof_points>
      <!-- FILL IN: [Replace these placeholder proof points with Shivani's actual verified achievements from cv-shivani.md once it is populated. Each proof point needs: id, name, context (employer/project), hero_metric (verbatim from cv-shivani.md), and archetypes it maps to.] -->
      <proof_point id="P1">
        <name><!-- FILL IN: [Primary Azure/data pipeline project name] --></name>
        <context><!-- FILL IN: [Employer or project context] --></context>
        <hero_metric><!-- FILL IN: [Quantified metric verbatim from cv-shivani.md] --></hero_metric>
        <archetypes>Azure Data Engineer, Data Platform Engineer, fallback</archetypes>
      </proof_point>
      <proof_point id="P2">
        <name><!-- FILL IN: [Secondary data pipeline or ETL/ELT project] --></name>
        <context><!-- FILL IN: [Employer or project context] --></context>
        <hero_metric><!-- FILL IN: [Quantified metric verbatim from cv-shivani.md] --></hero_metric>
        <archetypes>Azure Data Engineer, Analytics Engineer</archetypes>
      </proof_point>
      <proof_point id="P3">
        <name><!-- FILL IN: [Databricks or Synapse Analytics project] --></name>
        <context><!-- FILL IN: [Employer or project context] --></context>
        <hero_metric><!-- FILL IN: [Quantified metric verbatim from cv-shivani.md] --></hero_metric>
        <archetypes>Azure Data Engineer, Data Platform Engineer</archetypes>
      </proof_point>
      <proof_point id="P4">
        <name><!-- FILL IN: [Data warehouse or data lakehouse project] --></name>
        <context><!-- FILL IN: [Employer or project context] --></context>
        <hero_metric><!-- FILL IN: [Quantified metric verbatim from cv-shivani.md] --></hero_metric>
        <archetypes>Data Platform Engineer, Data Architect</archetypes>
      </proof_point>
      <proof_point id="P5">
        <name><!-- FILL IN: [Reporting, BI, or analytics project] --></name>
        <context><!-- FILL IN: [Employer or project context] --></context>
        <hero_metric><!-- FILL IN: [Quantified metric verbatim from cv-shivani.md] --></hero_metric>
        <archetypes>Analytics Engineer, Azure Data Engineer</archetypes>
      </proof_point>
      <proof_point id="P6">
        <name><!-- FILL IN: [Data governance, data quality, or cost optimization project] --></name>
        <context><!-- FILL IN: [Employer or project context] --></context>
        <hero_metric><!-- FILL IN: [Quantified metric verbatim from cv-shivani.md] --></hero_metric>
        <archetypes>Data Architect, Data Platform Engineer</archetypes>
      </proof_point>
    </approved_proof_points>

    <archetype_allocation>
      <rule archetype="Azure Data Engineer">Paragraph 2 must use 2-3 of: P1, P2, P3.</rule>
      <rule archetype="Data Platform Engineer">Paragraph 2 must use 2-3 of: P3, P4, P6.</rule>
      <rule archetype="Analytics Engineer">Paragraph 2 must use P2 and P5 (both required), plus one platform detail from cv-shivani.md (specific tool, scale metric, or performance improvement).</rule>
      <rule archetype="Data Architect">Paragraph 2 must use P4 + P6 plus a governance or modeling detail verbatim from cv-shivani.md.</rule>
      <rule archetype="Other / fallback">Paragraph 2 uses P1 + the candidate background narrative; do not cherry-pick metrics from outside the locked list.</rule>
    </archetype_allocation>
    ...
    <scoring_rubric>
      ...
      <criteria>
        ...
        <criterion name="Contextual Authenticity" max="15">
          <component points="5">Hook ties to candidate background (Azure Data Engineering experience applied to target role)</component>
...
\raisebox{-0.1\height}\faPhone\ <!-- FILL IN: [Shivani's phone number] --> ~
\href{<!-- FILL IN: [Shivani's LinkedIn URL] -->}{\raisebox{-0.2\height}\faLinkedin\ \underline{Linkedin}} ~
\href{<!-- FILL IN: [Shivani's GitHub URL if applicable] -->}{\raisebox{-0.2\height}\faGithub\ \underline{GitHub}} ~
\vspace{-8pt}
\end{center}
...
[PARAGRAPH 1: Hook -- 3-4 sentences. Names role + company. Leads with Azure Data Engineering background. One hero metric.]
