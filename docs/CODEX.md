...
- Node.js 18+
- agent-browser installed for PDF generation and reliable job verification
...
- Never verify a job’s live status with WebFetch when agent-browser is available.
