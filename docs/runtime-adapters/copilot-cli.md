# Copilot CLI Adapter Status

Copilot CLI is **documented-only** in this repository.

## What this means

- This guidance is **not part of this PR** as a shipped adapter implementation.
- Any future Copilot CLI adapter must read `runtime/modes.yml`, `runtime/context-loading.yml`, and `runtime/operating-rules.md`.
...
2. Treat Copilot-specific UX as adapter-scoped only.
