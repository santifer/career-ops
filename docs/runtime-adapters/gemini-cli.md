# Gemini CLI Adapter Status

Gemini CLI is **documented-only** in this repository.

## What this means

- This guidance is **not part of this PR** as a shipped adapter implementation.
- Any future Gemini CLI adapter must read `runtime/modes.yml`, `runtime/context-loading.yml`, and `runtime/operating-rules.md`.
...
2. Treat Gemini-specific UX as adapter-scoped only.
