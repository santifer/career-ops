...
| `data/applications.md` | Your application tracker (rendered view when SQLite is enabled) |
| `data/applications.db` | Your application tracker database (SQLite, opt-in — see `tracker.mjs`) |
