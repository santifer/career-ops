...
| **Генератор супровідних листів** | Персоналізовані листи з дослідженням компанії, дзеркалюванням ключових слів, чотирма інтерактивними підказками (чому/проблеми/підхід/тон), підтвердженням чернетки в чаті та PDF A4. Автоматична чернетка при кожній оцінці; завершення та генерація через `/career-ops cover` |
...
/career-ops cover      → Генератор супровідних листів (вставте JD або /career-ops cover {slug})
...
- **Супровідні листи**: Python + ReportLab (PDF A4, системні шрифти, без зовнішніх залежностей)
