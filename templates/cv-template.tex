...
\begin{document}
    \begin{center}
        ...
        % LINKEDIN
        \href{https://{{LINKEDIN_URL}}}{\raisebox{-0.2\height}\faLinkedin\ \underline{{{LINKEDIN_DISPLAY}}}}  ~
        % GITHUB
        \href{https://{{GITHUB_URL}}}{\raisebox{-0.2\height}\faGithub\ \underline{https://{{GITHUB_URL}}}}
    \end{center}
