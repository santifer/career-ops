...
| **Генератор сопроводительных писем** | Персонализированные письма с исследованием компании, зеркалированием ключевых слов, четырьмя интерактивными подсказками (почему/проблемы/подход/тон), подтверждением черновика в чате и PDF A4. Автоматический черновик при каждой оценке; завершение и генерация через `/career-ops cover` |
...
/career-ops cover                 → Генератор сопроводительных писем (вставьте JD или /career-ops cover {slug})
...
- **Сопроводительные письма**: Python + ReportLab (PDF A4, системные шрифты, без внешних зависимостей)
