...
> **Важно: это НЕ инструмент для массовой рассылки.** Career-ops — это фильтр. Он помогает найти те немногие вакансии, которые стоят вашего времени, из сотен. Система настоятельно рекомендует не откликаться на вакансии с оценкой ниже 3.5/5. Ваше время ценно, как и время рекрутера. Всегда проверяйте перед отправкой.
...
| **Сканер порталов** | 45+ компаний + поддержка российских площадок (hh.ru, Хабр Карьера, trudvsem.ru и др. — настраиваются в portals.yml) |
