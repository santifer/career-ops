...
- **Сканирует порталы** автоматически (Greenhouse, Ashby, Lever, hh.ru, Хабр Карьера и др.)
...
| **Сканер порталов** | 45+ компаний + российские площадки (hh.ru, Хабр Карьера, trudvsem.ru, rabota.ru и др.) |
...
/career-ops contacto              → Сообщение в LinkedIn/Telegram
...
## Предварительно настроенные порталы

Сканер включает **45+ международных компаний** и **российские площадки**:

**AI Labs:** Anthropic, OpenAI, Mistral, Cohere, LangChain, Pinecone
**Voice AI:** ElevenLabs, PolyAI, Parloa, Hume AI, Deepgram
**AI Platforms:** Retool, Airtable, Vercel, Temporal, Glean
**Automation:** n8n, Zapier, Make.com
**🇷🇺 Россия:** hh.ru, Хабр Карьера, trudvsem.ru, rabota.ru, Superjob, Geekjob

**Джоб-борды:** Ashby, Greenhouse, Lever, Wellfound, Workable + hh.ru API, trudvsem.ru API
...
│   ├── portals.example.yml      # Конфигурация сканера (вкл. 🇷🇺)
...
- **Сканер**: Playwright + Greenhouse API + WebSearch + hh.ru API
