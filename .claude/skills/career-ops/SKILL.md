...
Available commands:
  ...
  /career-ops reflect   → Scoring loop: revisa eventos e propõe calibração
  /career-ops correct   → Override manual de outcome para um report_id
  /career-ops learn now → Trigger explícito do scoring-parser passivo
...
Applies to: `tracker`, `deep`, `training`, `project`, `patterns`, `followup`, `reflect`, `correct`, `learn-now`
