...
Strategic context lives in `PRODUCT.md` (register: product, personality: warm/approachable/smart, five design principles). Visual direction lives in `DESIGN.md` (Creative North Star: "The Well-Lit Desk", restrained color strategy with violet accent, single warm sans typography, responsive motion). The frontend should not drift into a generic chatbot wrapper or corporate SaaS dashboard; the differentiated surface is the visible profile plus annotation/approval loop.
