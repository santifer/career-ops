...
| `/career-ops-pdf` | `/career-ops pdf` | Generate ATS-optimized CV (single job) |
| `/career-ops-pdf2` | `/career-ops pdf2` | Batch PDFs for multiple jobs in parallel |
...
| Wants PDFs for multiple jobs in parallel | `pdf2` |
