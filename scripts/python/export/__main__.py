"""Allow running: python -m scripts.python.export [command] [args...]"""
from __future__ import annotations

import sys

COMMANDS = {
    "build-dashboard": "scripts.python.export.build_dashboard",
}
...
def main() -> None:
    if len(sys.argv) < 2 or sys.argv[1] in ("-h", "--help"):
        print(
            f"Usage: python -m scripts.python.export [command]\n\n"
