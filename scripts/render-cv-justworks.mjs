...
const vars = {
  ...
  EXPERIENCE: `
    ...
    <div class="job">
      ...
      <div class="job-location">Remote</div>
      <ul>
        <li>Shipped <strong>$245K–$2.2M software implementations</strong> for Department of Energy, defense, and regulated-industry clients — owning scope, schedule, risk, and executive comms end-to-end.</li>
    ...
    <div class="job">
      ...
      <div class="job-location">Atlanta, GA</div>
      <ul>
        <li>Built a five-year roadmap and investment plan that contributed to more than <strong>$14M in savings and cost avoidance</strong>; supported 350% portfolio growth (2 → 7 properties).</li>
      </ul>
    </div>
  `,
...
console.log('Wrote output/cv-aaliya-justworks-2026-04-14.html (' + html.length + ' bytes)');
